...
| T044 | 接入第二个真实本地引擎并完成往返切换、越南语试听、离线测试 | T040, T043 | P0 | TODO | AC-06 完整引擎部分；两套模拟器不算完成 |
...
| T104 | Windows 本地分发包、配置/数据说明、第三方许可证、已知限制及可重复打包 | T103 | P1 | TODO | 受支持机器安装/启动检查；三层证据可追溯；不自动发布 |
